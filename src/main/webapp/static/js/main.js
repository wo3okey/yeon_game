...
const canvasBtnReset = document.getElementById('reset-btn');
...
function initNext() {
    ...
    canvasBtnReset.style.width = 4 * BLOCK_SIZE + "px";
    canvasBtnReset.style.height = 1 * BLOCK_SIZE + "px";
}
...
function checkHighScore(score) {
    ...
    while (true) {
        ...
        if (expression.test(name)) {
            alert("put Name just english plz.");
            continue;
        }
